...
class FriendsTest extends TestCase
{
    ...
    public function a_user_id_and_status_is_required_for_friend_request_responses()
    {
        ...
        $responseString = json_decode($response->getContent(), true); // true는 객체를 array로 바꿔준다 array가 접근이 더쉽기떄문에 바꿔준다
    ...
    /** @test */
    public function a_user_id_is_required_for_ignoring_friend_request_responses()
    {
        $response = $this->actingAs($user = factory(\App\User::class)->create(),'api')
            ->delete('/api/friend-request-response/delete', [
                'user_id' => '',
